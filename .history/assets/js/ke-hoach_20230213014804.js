...
let workPlanListWeek5 = [
    ...
    new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], 
      ...
      new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []), 
      new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []), 
      new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0], [])]),
    new WorkPlan("abc", periodTagList[1], "03/02", "10/02", [], [memberList[0], memberList[2]], workStatusList[0], []),
    new WorkPlan("HRM v2 Hộp thư", periodTagList[1], "30/01", "04/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0], [])
];

let workPlanListWeek2 = [
    new WorkPlan("Xậy dựng và chốt OKRs các cá nhân", periodTagList[0], "12/01", "12/01", priorityList[2], [memberList[0], memberList[3]], workStatusList[3], 
