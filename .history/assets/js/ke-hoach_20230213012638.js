...
let workPlanListWeek5 = [
    ...
    ["Check in OKRs", periodStatus[0], "03/02", "03/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0], "Check in OKRs", periodStatus[0], "03/02", "03/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0], "Check in OKRs", periodStatus[0], "03/02", "03/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0]]),
    new WorkPlan("abc", periodStatus[0], "03/02", "10/02", "", [memberList[0], memberList[2]], workStatusList[0]),
    new WorkPlan("HRM v2 Hộp thư", periodStatus[0], "30/01", "04/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0], ["Check in OKRs", periodStatus[0], "03/02", "03/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0], "Check in OKRs", periodStatus[0], "03/02", "03/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0], "Check in OKRs", periodStatus[0], "03/02", "03/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0]]),
    new WorkPlan("Check in OKRs", periodStatus[0], "03/02", "03/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0]),
    new WorkPlan("abc", periodStatus[0], "03/02", "10/02", "", [memberList[0], memberList[2]], workStatusList[0]),
