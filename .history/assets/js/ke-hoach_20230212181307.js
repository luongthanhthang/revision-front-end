...
function addDropdownFilter(dropdownList) {
          ...
          <div class="dropdown is-hoverable is-size-7">
            ...
            <div class="dropdown-menu" role="menu">
              <div class="dropdown-content">
                ...
                for(let j = 0; j < dropdownList[i][1].length; j++) {
                    result += `
                    <div class="dropdown-item py-0">
                    <a class="icon-text is-align-items-center">
                      <span class="icon image is-16x16 mr-2">
                        <img class="is-rounded" src="${dropdownList[j][1]}" alt="IMG">                                
                      </span>
                      <span class="is-size-7">${dropdownList[j][0]}</span>
                     </a>
                </div>
                    `;
                }
    ...
    console.log(addDropdownFilter(filterList);