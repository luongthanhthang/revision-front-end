...
window.addEventListener("DOMContentLoaded", () => {
    ...
    planFilterContent.setAttribute("class", "filter-content columns");
    planFilterContent.setAttribute("id", "plan-filter-content");
    planDetailContent.innerHTML = addViewPlanFilterContent

    let planDetailContent = document.createElement("div");
    planDetailContent.setAttribute("class", "main-content");
    planDetailContent.setAttribute("id", "plan-main-content");
})
