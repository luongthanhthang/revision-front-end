...
let workPlanListWeek2 = [
    ...
    new WorkPlan("Follow Hi-fi", "", "10/01", "13/01", priorityList[2], [memberList[0], memberList[1]], workStatusList[0]),
    new WorkPlan("Xây dựng plan tuần", "", "13/01", "03/02", priorityList[2], [memberList[0], memberList[1]], workStatusList[0]),
];