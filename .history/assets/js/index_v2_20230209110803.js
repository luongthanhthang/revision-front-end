...
function deleteTodoList(idElement) {
  ...
  if(work) {
    if(document.getElementById(`view-title-${idElement}`)) {
      nameWorkDelete = document.getElementById(`view-title-${idElement}`).querySelector(".name-work-form").value;
  ...
  if (document.getElementById(`form-title-${idElement}`) && work === null) {
