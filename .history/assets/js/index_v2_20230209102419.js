...
function onloadLocalStorageTodoList() {
  ...
  console.log(Object.values(localStorage).sort(compare).forEach((item) => {
    console.log(item)
  });
...
function compare(a, b){
  ...
  let bHour = parseInt(JSON.parse(b).endTimeWorkForm.split(":")[0]);
  let bMinute = parseInt(JSON.parse(b).endTimeWorkForm.split(":")[1]);
