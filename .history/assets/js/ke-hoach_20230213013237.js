...
let workPlanListWeek2 = [
    new WorkPlan("Xậy dựng và chốt OKRs các cá nhân", periodStatus[0], "12/01", "12/01", priorityList[2], [memberList[0], memberList[3]], workStatusList[3], [new WorkPlan("Follow Hi-fi", "", "10/01", "13/01", priorityList[0], [memberList[0], memberList[3]], workStatusList[4], [])]),
