...
function createOptions(array, name) {
  let result = "";
  array.map((item) => {
...
function renderHtmlFormTitle(todoListItem, keyItem) {
  return ` <td>
  <input
...
<td>
  <div class="work-status box-shadow-5px">
    <select name="" class="category-work-form" value ="${
      todoListItem.categoryWorkForm
    }">
...
<td>
  <div class="work-status box-shadow-5px">
    <select class = "select-time start-time-work-form" value ="${
      todoListItem.startTimeWorkForm
    }">
    </select>
  </div>
</td>
...
<td>
  <div class="work-status box-shadow-5px">
    <select class = "select-time end-time-work-form"  value ="${
      todoListItem.endTimeWorkForm
    }">
    </select>
  </div>
</td>
...
<td>
  <div class="dropdown click">
    ...
    <div class="dropdown-menu">
      <div class="dropdown-content">
        <div
          onclick="updateStatusWork(this, ${keyItem})"
          class="dropdown-item">
          Todo
        </div>
        <div
...
function renderHtmlFormDetail(todoListItem, keyItem) {
  return `<td colspan="3">
