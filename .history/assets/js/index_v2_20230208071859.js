...
// import addViewTitle from "./function/todolist/addViewTitle";
// import addViewDetail from "./function/todolist/addViewDetail";
// import checkAdvice from "./function/todolist/checkAdvice";
...
function renderHtmlFormTitle(todoListItem, categoryList, priorityList, arrayDropdown, arrayTime) {
  return ` <td>
  <input
...
<td>
  <div class="work-status box-shadow-5px">
    ...
    ${createOptions(arrayTime, todoListItem.startTimeWorkForm)}
    </select>
  </div>
</td>
...
function renderHtmlViewTitle(todoListItem, arrayDropdown) {
  ...
  <div class="dropdown-menu">
    <div class="dropdown-content">
     ${createDropdown(arrayDropdown ,itodoListItemtem)}
    </div>
  </div>
</div>
  </td>`;
