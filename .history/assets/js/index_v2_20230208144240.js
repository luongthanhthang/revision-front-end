...
function onloadLocalStorageTodoList() {
  ...
  Object.values(localStorage).forEach((item) => {
    ...
    viewDetail
      .querySelector(".showFormEdit")
      .addEventListener("click", () => {
        showFormEdit(JSON.parse(item).id);
      });
      viewDetail
      .querySelector(".deleteTodoList")
      .addEventListener("click", () => {
...
function update(idElement) {
  ...
  let categoryWorkForm = contentTitle.querySelector(
    ".category-work-form"
  ).value;
  let priorityWorkForm = contentTitle.querySelector(
    ".priority-work-form"
  ).value;
  let startTimeWorkForm = contentTitle.querySelector(
    ".start-time-work-form"
  ).value;
  let endTimeWorkForm = contentTitle.querySelector(
    ".end-time-work-form"
  ).value;
  let detailWorkForm =
    contentDetail.querySelector(".detail-work-form").value;
  let resultWorkForm =
    contentDetail.querySelector(".result-work-form").value;
  let statusWorkValue =
    contentTitle.querySelector(".status-work-value").innerText;
