...
function compare(a , b){
  let aHour = parseInt(a.startTimeWorkForm.split(":")[0]);
  let aMinute = parseInt(a.startTimeWorkForm.split(":")[1]);
  let bHour = parseInt(b.endTimeWorkForm.split(":")[0]);
  let bMinute = parseInt(b.endTimeWorkForm.split(":")[1]);

  if((aHour < bHour) 
        || (aHour === hourStartHourCurrent && minuteStartHourItem < minuteStartHourCurrent)){
