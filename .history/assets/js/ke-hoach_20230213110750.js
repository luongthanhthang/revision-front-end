...
function showViewSubMenu(thisElement) {
  thisElement.parentNode.parentNode.parentNode.parentNode.nextSibling.nextElementSibling.childNodes.push(thisElement);classList.toggle('is-active-flex');
  // thisElement.parentNode.parentNode.parentNode.parentNode.nextSibling.classList.toggle('is-active-flex');
}
