...
let filterList = [[["Thành viên", "Tất cả thành viên"], memberList], [["Thời hạn", "Tất cả"], periodStatus], 
[["Trạng thái" , "Tất cả"], workStatusList], 
[["Độ ưu tiên" , "Tất cả"], priorityList], 
[["Nhãn dán", "Tất cả"] labelList]];
            ...
            <div class="dropdown-menu" role="menu">
              <div class="dropdown-content">
                <div class="dropdown-item">
                  <a class="has-text-weight-semibold has-text-black">Tất cả thành viên</a>
                </div>
                <div class="dropdown-item py-0">
                  <a class="icon-text is-align-items-center">
                    <span class="icon image is-16x16 mr-2">
                      <img class="is-rounded" src="https://work.conando.vn/upload/220223/637812349690327647.jpg" alt="IMG">                                
                    </span>
                    <span class="is-size-7">Nguyễn Hữu Học</span>
                   </a>
                </div>
                <div class="dropdown-item py-0">
                  <a class="icon-text is-align-items-center">
