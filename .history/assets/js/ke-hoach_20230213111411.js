...
function showViewSubMenu(thisElement) {
  ...
  thisElement.querySelector(".click").innerText !== "expand_more" ? thisElement.querySelector(".click").innerText = "expand_more" : thisElement.querySelector(".click").innerText = "chevron_right";
}
