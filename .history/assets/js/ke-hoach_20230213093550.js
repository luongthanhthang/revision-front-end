...
<ul class="columns is-gapless font-13 m-0" style="border-left: 4px solid black;">
  <li class="column" style="width: calc(100% - 630px);">
    <div class="columns is-justify-content-space-between is-align-items-center m-0 pl-2" style="width: 100%;">
      ...
      <div class="column is-narrow">
        <span class="tag" style="background: ${work.periodStatus[2]}; color: ${work.periodStatus[1]};">${work.periodStatus[2]}</span>
      </div>` : ""}
  ...
  <li class="column is-narrow" style="width: 130px;">
    <div class="icon-text has-text-grey">
      ...
      <span class="has-text-weight-normal has-text-black">03/02 -03/02</span>
    </div>
  </li>
  <li class="column is-narrow" style="width: 130px;">
    <span class="tag" style="background: #FF544930; color: #555;">Trễ hạn</span>
  </li>
  <li class="column is-narrow" style="width: 110px;">
    <div class="list-member icon-text">
      <span class="image is-24x24" title="Nguyễn Hữu Học">
        <img class="is-rounded" src="https://work.conando.vn/upload/220223/637812349690327647.jpg" alt="AVATAR">
      </span>
      <span class="image is-24x24" title="Nguyễn Hữu Học">
        <img class="is-rounded" src="https://work.conando.vn/upload/220223/637812349690327647.jpg" alt="AVATAR">
      </span>
