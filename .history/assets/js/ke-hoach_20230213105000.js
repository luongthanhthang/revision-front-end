      ...
      <div class="icon-text">
        ...
        <span class="icon ml-0">
          ${work.subWork.length != 0 
            ? `<span class="click material-icons material-icons-outlined is-size-5" onclick="view">arrow_right</span>` : ""}             
        </span>  
...
function addSubContent(subWorkList) {
  ...
  subWorkList.forEach((subWork) => {
    result += `
                    <ul class="sub-content columns is-gapless font-13 m-0" style="border-left: 4px solid ${subWork.priority.length !=0 ? subWork.priority[1] : "#dddddd"};">
