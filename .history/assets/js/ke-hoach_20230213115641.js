      ...
      <div class="dropdown is-right is-active">
        ...
        <div class="dropdown-menu" id="dropdown-menu-${work.id}" role="menu">
          <div class="dropdown-content">
            <ul class = "columns dropdown-item">
            <div class="icon-text"><span class="image is-rounded is-24x24"><img src="/upload/220223/637812349690327647.jpg" alt="AVT"></span><!--!-->
            <span class="ml-2" style="flex-grow: 1;">Nguyễn Hữu Học</span></div>
              <li class = "column is-narrow">s</li>
              <li class = "column" style ="space-white: nowrap">Thực hiện</li>
            </ul>
          </div>
        </div>
      </div>      
