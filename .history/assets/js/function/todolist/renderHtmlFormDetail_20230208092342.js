export default function renderHtmlFormDetail(todoListItem) {
  ...
  <td colspan="3">
    <div class="control">
      <div class="createTodolist" onclick="create(${todoListItem.id})" class="click edit blue-text">
      ...
      <div class="createTodolist" onclick="deleteTodoList(${todoListItem.id})" class="click remove red-text">
        <span class="icon material-icons material-symbols-outlined">
          delete
        </span>
        <span>Xoá</span>
