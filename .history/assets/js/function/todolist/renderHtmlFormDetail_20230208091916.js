export default function renderHtmlFormDetail(todoListItem) {
  ...
  <td colspan="3">
    <div class="control">
      <div id="createTodolist-${todoListItem.id}" onclick="create(${todoListItem.id})" class="click edit blue-text">
      ...
      <div id="createTodolist" onclick="deleteTodoList(${todoListItem.id})" class="click remove red-text">
        <span class="icon material-icons material-symbols-outlined">
          delete
        </span>
        <span>Xoá</span>
