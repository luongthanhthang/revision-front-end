...
export function getTimeSelectEnd(startTimeWorkFormNode, endTimeWorkFormValueNode){
  ...
  if(optionsList['timeList'].findIndex(startTimeWorkFormNode.value) > optionsList['timeList'](endTimeWorkFormValueNode.value)) {
    endTimeWorkFormValueNode.value = timeList[timeList.findIndex(startTimeWorkFormNode.value) + 1];
  } else {
      return null;
  }
}
