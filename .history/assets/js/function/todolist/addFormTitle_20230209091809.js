...
import {changeSelectTimeEnd, changeSelectTimeStart} from "./createOptions.js"
...
export default function addFormTitle(todoListItem) {
  ...
  startTimeWorkForm.addEventListener("change", () => {
    changeSelectTimeEnd(startTimeWorkForm, endTimeWorkForm);
  });

  endTimeWorkForm.addEventListener("change", () => {
    changeSelectTimeStart(startTimeWorkForm, endTimeWorkForm);
  });
  return formTitle;
}
