...
function getTimeSelectEnd(idElement, indexStartTime){
    console.log(document.getElementById(`form-title-${thisElement}`));
    let endTimeElement = document.getElementById(`form-title-${thisElement}`).querySelector(".end-time-work-form");
