...
function getTimeSelectEnd(thisElement, indexStartTime){
    let endTimeElement = thisElement.parentNode.parentNode.parentNode.nextSibling.getElementsByTagName("");
    if(timeList.findIndex(endTimeElement.value) < indexStartTime) {
