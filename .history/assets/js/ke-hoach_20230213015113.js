...
let workStatusList = [["Todo", "#4a4a4a"], ["Doing", "#4a4a4a"], ["Review", "#4a4a4a"], ["Todo", "#4a4a4a"], ["Todo", "#4a4a4a"]];
...
let statusWorkTagList = [["Dự án", "#1f81b2"], ["Vận hành", "#d34a51"], ["Khác", "#3aa51d"], ["Marketing", "#5f8e25"], ["HR", "#c207c5"]];
...
let workPlanListWeek5 = [
    new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []),
    new WorkPlan("abc", periodTagList[1], "03/02", "10/02", [], [memberList[0], memberList[2]], workStatusList[0], 
      [new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []), 
      new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []), 
      new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []), 
      new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], [])]),
    new WorkPlan("HRM v2 Hộp thư", periodTagList[1], "30/01", "04/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []),
    new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], 
      [new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []), 
      new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []), 
      new WorkPlan("Check in OKRs", periodTagList[1], "03/02", "03/02", priorityTagList[2], [memberList[0], memberList[1]], workStatusList[0], []), 
...
let workPlanListWeek2 = [
    new WorkPlan("Xậy dựng và chốt OKRs các cá nhân", periodTagList[0], "12/01", "12/01", priorityTagList[2], [memberList[0], memberList[3]], workStatusList[3], 
      [new WorkPlan("Follow Hi-fi", [], "10/01", "13/01", priorityTagList[0], [memberList[0], memberList[3]], workStatusList[4], []), 
      new WorkPlan("Follow Hi-fi", [], "10/01", "13/01", priorityTagList[0], [memberList[0], memberList[3]], workStatusList[4], [])]),
    new WorkPlan("Follow Hi-fi", [], "10/01", "13/01", priorityTagList[0], [memberList[0], memberList[3]], workStatusList[4], []),
    new WorkPlan("Xây dựng plan tuần", [], "13/01", "13/01", priorityTagList[2], [memberList[0], memberList[3]], workStatusList[3], 
      [new WorkPlan("Follow Hi-fi", [], "10/01", "13/01", priorityTagList[0], [memberList[0], memberList[3]], workStatusList[4], []), 
      new WorkPlan("Follow Hi-fi", [], "10/01", "13/01", priorityTagList[0], [memberList[0], memberList[3]], workStatusList[4], [])]),
    new WorkPlan("Xậy dựng và chốt OKRs các cá nhân", periodTagList[0], "12/01", "12/01", priorityTagList[2], [memberList[0], memberList[3]], workStatusList[3], []),
    new WorkPlan("Follow Hi-fi", [], "10/01", "13/01", priorityTagList[0], [memberList[0], memberList[3]], workStatusList[4], []),
